        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(children: [
              ...
              Align(
               ...
               Align(
                alignment: Alignment.centerLeft,
                heightFactor: 2,
                child: Text("${state.post!.donator_count} people donated so far.",
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Goal: ${state.post!.goal} birr", 
                    style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15),),
                    Text("Raised: ${state.post!.donated} birr",
            ...
            const SizedBox(height: 10,),
              ...
              onPressed: (){
                context.pushNamed('donate', params: {'id': state.post!.id.toString(), 'post': state.post.toString()});
              }, 
           ...
           return Scaffold(body: Center(child: Text('Failed')),);}
